...
def run_fcast_app():
    ...
    st.write('''### Description
        - Testing Results: 
            * The most recent n days (n = user input for forecast) are used as a testing set for model.
            The remaining data is used to train the model.
            * A good model should capture most of the real data (green line) within P75 & P25.
            * The bigger the forecast duration, the more the forecast becomes less accurate.

        - Key:
            * Dark yellow bands represent the 75th (P75) & 25th (P25) pecrentiles.
            * Light yellow bands represent the 90th (P90) & 10th (P10) percentiles.
