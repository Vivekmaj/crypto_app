...
def run_fcast_app():
    ...
    st.write('''### Description
        - Testing Results:
            ...
            * When a user selects the forecast period, the most recent batch of those number of days are used to test the model,
            all the data before that batch is used to train the model.
